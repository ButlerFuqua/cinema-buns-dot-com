...
// Twitter specific
export const INSTAGRAM_HANDLE = '@cinemabunspodcast'; // Replace with your actual Twitter handle
export const TIKTOK_HANDLE = '@cinemabunspodcast'; // Replace with your actual Twitter handle

// App & SEO
export const SITE_NAME = 'Cinema Buns';
export const THEME_COLOR = '#e08c21'; // Your brand color